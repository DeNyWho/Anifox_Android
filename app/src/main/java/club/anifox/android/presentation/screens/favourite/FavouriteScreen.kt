package club.anifox.android.presentation.screens.favourite
...
fun FavouriteScreen(
    ...
    viewModel: FavouriteViewModel = getViewModel()
) {
    Content(modifier)
}
...
private fun Content(modifier: Modifier) {
    Column(
        ...
        Text(
            ...
            text = stringResource(R.string.in_plan_screen_favourite),
